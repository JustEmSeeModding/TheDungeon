...
public class ArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public final ModelPart leggingsTop;

    public ArmorModel(ModelPart pRoot) {
        super(pRoot);
        this.leftBoot = pRoot.getChild("left_boot");
        this.rightBoot = pRoot.getChild("right_boot");
        if (pRoot.hasChild("leggings_top"))
            this.leggingsTop = pRoot.getChild("leggings_top");
        else leggingsTop = null;
    }
    ...
    public void setAllVisible(boolean pVisible) {
        ...
        if (leggingsTop != null)
            this.leggingsTop.visible = pVisible;
    }
    ...
    public void setupAnim(LivingEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
        ...
        if (leggingsTop != null) {
            this.leggingsTop.copyFrom(body);
        }
    }
    ...
    public void renderToBuffer(@NotNull PoseStack stack, @NotNull VertexConsumer consumer, int packedLight, int packedOverlay, int color) {
        ...
        if (leggingsTop != null)
            this.leggingsTop.render(stack, consumer, packedLight, packedOverlay, color);
    }
}
