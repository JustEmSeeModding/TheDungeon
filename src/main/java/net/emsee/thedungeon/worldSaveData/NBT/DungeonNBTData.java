...
public final class DungeonNBTData {
    ...
    private final Map<Dungeon.DungeonRank,Boolean> isOpen  = Map.of(
            Dungeon.DungeonRank.F, false,
            Dungeon.DungeonRank.E, false,
            Dungeon.DungeonRank.D, false,
            Dungeon.DungeonRank.C, false,
            Dungeon.DungeonRank.B, false,
            Dungeon.DungeonRank.A, false,
            Dungeon.DungeonRank.S, false,
            Dungeon.DungeonRank.SS, false
    );
    ...
    public CompoundTag SerializeNBT() {
        ...
        if (TheDungeon.debugMode.is(TheDungeon.DebugMode.ALL)) TheDungeon.LOGGER.info("isOpen: {}", ListAndArrayUtils.mapToString(isOpen));
        toReturn.putString("nextToCollapse", nextToCollapse.getName());
        if (TheDungeon.debugMode.is(TheDungeon.DebugMode.ALL)) TheDungeon.LOGGER.info("nextToCollapse: {}", nextToCollapse);
        ...
        if (TheDungeon.debugMode.is(TheDungeon.DebugMode.ALL)) TheDungeon.LOGGER.info("dungeonPassiveQueue: {}", ListAndArrayUtils.mapToString(dungeonPassiveQueue));
        ...
        if (TheDungeon.debugMode.is(TheDungeon.DebugMode.ALL)) TheDungeon.LOGGER.info("portalPositions: {}", ListAndArrayUtils.mapToString(portalPositions));
        return toReturn;
    }
    ...
    public Queue<Dungeon> getDungeonPassiveQueue(Dungeon.DungeonRank rank) {return dungeonPassiveQueue.get(rank);}
    ...
    public Dungeon.DungeonRank getNextToCollapse() {return nextToCollapse;}
    public void setNextToCollapse(Dungeon.DungeonRank rank) {nextToCollapse = rank;}
}
