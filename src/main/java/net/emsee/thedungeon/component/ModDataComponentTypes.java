...
public class ModDataComponentTypes {
    ...
    public static final Supplier<DataComponentType<Integer>> ITEM_SAVED_DUNGEON_ID = register("item_dungeon_id",
            builder -> builder.persistent(Codec.INT));

    public static final Supplier<DataComponentType<BlockPos>> COMPAS_SAVED_BLOCK_POS= register("compas_block_pos",
