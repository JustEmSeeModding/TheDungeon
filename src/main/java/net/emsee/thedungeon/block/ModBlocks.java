...
public final class ModBlocks {
    ...
    public static final SimpleBlockGroup.ItemBlockAndOreAndDeepslateOre PYRITE_BLOCKS = new SimpleBlockGroup.ItemBlockAndOreAndDeepslateOre("pyrite",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK)),
             () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_ORE)),
             () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE_GOLD_ORE)));
    ...
    public static final DeferredBlock<DungeonBlock> INFUSED_STONE = registerBlock("infused_stone",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE)));

    public static final DeferredBlock<DungeonBlock> INFUSED_DEEPSLATE = registerBlock("infused_deepslate",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE)));

    public static final DeferredBlock<DungeonBlock> INFUSED_STONE_BRICKS = registerBlock("infused_stone_bricks",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS)));
    ...
    public static final DeferredBlock<DungeonBlock> INFUSED_END_STONE = registerBlock("infused_end_stone",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE)));

    public static final DeferredBlock<DungeonBlock> INFUSED_END_STONE_BRICKS = registerBlock("infused_end_stone_bricks",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE_BRICKS)));
    ...
    public static final SimpleBlockGroup.ItemBlockAndRawAndOreAndDeepslateOre GILDREAN_BLOCKS = new SimpleBlockGroup.ItemBlockAndRawAndOreAndDeepslateOre("gildrean",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK)),
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RAW_GOLD_BLOCK)),
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK)),
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE_GOLD_ORE)));

    public static final DeferredBlock<DungeonBlock> INGILDERD_BLACKSTONE = registerBlock("ingilderd_blackstone",
            () -> new DungeonBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GILDED_BLACKSTONE)));
    ...
    private static <T extends Block> void registerBlockItem(String name, DeferredBlock<T> block) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().rarity(Rarity.RARE)
