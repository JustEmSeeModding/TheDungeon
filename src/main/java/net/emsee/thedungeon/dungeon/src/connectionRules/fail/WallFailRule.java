...
public class WallFailRule extends FailRule {
    ...
    public WallFailRule(String tag, int width, int height, int heightOffset, boolean offsetOut, Supplier<BlockState> block) {
        super(tag, true, false);
        this.width = width;
        this.height = height;
    ...
    public WallFailRule(String tag, int width, int height, int heightOffset, boolean offsetOut, Supplier<BlockState> block, int blocksPerLoop) {
        super(tag, true, false);
        this.width = width;
        this.height = height;
        this.heightOffset = heightOffset;
