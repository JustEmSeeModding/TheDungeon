...
public final class GoblinCavesGridRoomCollection extends GridRoomCollection {
    ...
    private static GridRoomGroup t_large_deepslate() {
        return ((GridRoomGroup) new GridRoomGroup(11, 11).setSizeHeight(3, 3, 1).horizontalConnections(1, 1, 0, 1).setAllConnectionTags("deepslate_caves").doAllowRotation())
                .addRoom(new GridRoom(11, 11)
                        .withResourceLocation("goblin_caves/stone/t_large/one")
                        .withWeight(2)
                        .setSizeHeight(3, 3, 1)
    ...
    private static GridRoomGroup i_deepslate() {
        return ((GridRoomGroup) new GridRoomGroup(11, 11).horizontalConnections(1, 0, 1, 0).setAllConnectionTags("deepslate_caves").doAllowRotation())
                .addRoom(new GridRoom(11, 11)
                        .withResourceLocation("goblin_caves/stone/i/one")
                        .withWeight(10)
                        .horizontalConnections(1, 0, 1, 0)
    ...
    private static GridRoomGroup l_deepslate() {
        return ((GridRoomGroup) new GridRoomGroup(11, 11).horizontalConnections(1, 1, 0, 0).setAllConnectionTags("deepslate_caves").doAllowRotation())
                .addRoom(new GridRoom(11, 11)
                        .withResourceLocation("goblin_caves/stone/l/one")
                        .withWeight(10)
                        .horizontalConnections(1, 1, 0, 0)
