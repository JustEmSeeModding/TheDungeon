...
public final class ModAttributes {
    ...
    public static final Holder<Attribute> DUNGEON_MOB_MIN_PERCEPTION = register("dungeon.min_perception", new RangedAttribute("attribute.thedungeon.name.generic.min_aggro", 250, 0, 2048).setSyncable(true));
    /** any player aggro above this value is doubled */
    public static final Holder<Attribute> DUNGEON_MOB_MAX_PERCEPTION = register("dungeon.max_perception", new RangedAttribute("attribute.thedungeon.name.generic.min_aggro", 750, 0, 2048).setSyncable(true));
