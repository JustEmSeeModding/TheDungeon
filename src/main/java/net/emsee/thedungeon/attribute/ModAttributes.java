...
public final class ModAttributes {
    ...
    public static final Holder<Attribute> PLAYER_DUNGEON_AGGRO_TO_ENEMY = register("dungeon.aggro_to_enemy", new RangedAttribute("attribute.thedungeon.name.generic.aggro_to_enemy", 500, 50, 2048).setSyncable(true));
