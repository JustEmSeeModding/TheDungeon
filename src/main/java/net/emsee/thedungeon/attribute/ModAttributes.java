...
public final class ModAttributes {
    ...
    /** the flat damage reduction for an entity*/
    ...
    public static final Holder<Attribute> PLAYER_DUNGEON_AGGRO_TO_ENEMY = register("dungeon.aggro_to_enemy", () -> new RangedAttribute("attribute.thedungeon.name.generic.aggro_to_enemy", 500, 50, 2048).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
    /** any player aggro below this value is halved */
    public static final Holder<Attribute> DUNGEON_MOB_MIN_PERCEPTION = register("dungeon.min_perception", () -> new RangedAttribute("attribute.thedungeon.name.generic.min_perception", 250, 0, 2048).setSyncable(true));
    /** any player aggro above this value is doubled */
    public static final Holder<Attribute> DUNGEON_MOB_MAX_PERCEPTION = register("dungeon.max_perception", () -> new RangedAttribute("attribute.thedungeon.name.generic.max_perception", 750, 0, 2048).setSyncable(true));
